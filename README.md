# YSD-FCA - Unofficial Facebook Chat API for YSD Projects

This repository is a fork from the main [Facebook Chat API repository](https://github.com/Schmavery/facebook-chat-api) and will usually have new features bundled faster than the main repository (and maybe bundle some bugs, too).

## Unofficial Facebook Chat API
<img alt="version" src="https://img.shields.io/github/package-json/v/yuebot/ysd-fca?label=github&style=flat-square">
...
To avoid logging in every time you should save AppState (cookies etc.) to a file, then you can use it without having the password in your scripts.
...
3. **What do I do when `login` doesn't work?**
   > First check that you can log in to Facebook using the website. If login approvals are enabled, you might be logging in incorrectly. For how to handle login approvals, read our docs on [`login`](DOCS.md#login).
